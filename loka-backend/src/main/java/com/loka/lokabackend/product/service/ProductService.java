package com.loka.lokabackend.product.service;

import com.loka.lokabackend.product.dto.ProductDTO;
import com.loka.lokabackend.product.model.Product;
import com.loka.lokabackend.product.repository.ProductRepository;
    ...
    private void seedProducts() {
        List<Product> products = Arrays.asList(
                Product.builder()
                        ...
                        .description(
                                "A masterpiece of couture craftsmanship. This silk evening gown flows with effortless grace, featuring hand-stitched details and a silhouette that celebrates the feminine form. Perfect for black-tie events and gala evenings.")
                ...
                Product.builder()
                        ...
                        .description(
                                "Crafted from the finest Grade-A Mongolian cashmere, this overcoat is the definition of refined elegance. Double-breasted silhouette with hand-finished edges and signature horn buttons.")
                ...
                Product.builder()
                        ...
                        .description(
                                "Structured Italian leather tote with gold-plated hardware. Spacious interior with suede lining, multiple compartments, and a secure top zip. An investment piece for everyday luxury.")
                ...
                Product.builder()
                        ...
                        .description(
                                "18K gold-plated chain bracelet with a lobster clasp. Delicate yet striking, this piece adds understated luxury to any ensemble.")
                ...
                Product.builder()
                        ...
                        .description(
                                "A contemporary silhouette in the finest Italian merino wool. Fully lined, with satin-covered buttons and a single back vent. The cornerstone of a modern wardrobe.")
                ...
                Product.builder()
                        ...
                        .description(
                                "Hand-welted Oxford shoes crafted from full-grain calf leather. A Goodyear welt construction ensures longevity, while the leather sole develops character with every wear.")
                ...
                Product.builder()
                        ...
                        .description(
                                "Ethereal chiffon midi dress with a delicate floral print. Features a wrap front, adjustable tie waist, and flutter sleeves that move beautifully with every step.")
                ...
                Product.builder()
                        ...
                        .description(
                                "Hand-rolled silk pocket square with a classic geometric pattern. The perfect finishing touch to elevate any tailored look.")
                ...
                Product.builder()
                        ...
                        .description(
                                "Precision-cut trousers in a mid-weight wool-blend fabric. Flat-front with a clean silhouette, side pockets, and a half-lining for comfort. The benchmark of modern tailoring.")
                ...
                Product.builder()
                        ...
                        .description(
                                "Evening clutch in lustrous satin with a gold-tone frame closure and detachable chain strap. Lined in ivory silk with a compact mirror. Made to accompany you to life's finest moments.")
                ...
                Product.builder()
                        ...
                        .description(
                                "Relaxed linen dress with a square neckline and smocked bodice. Breathable and effortlessly chic, it transitions seamlessly from the beach to a terrace dinner.")
                ...
                Product.builder()
                        ...
                        .description(
                                "Ultra-fine two-ply cashmere turtleneck. Featherlight yet incredibly warm, with a ribbed cuff and hem for a refined finish. A luxury staple for cooler seasons.")
